...
if (!empty($search)) {
    $sql .= " AND (trainer_id LIKE '%$search%' OR user_id LIKE '%$search%' OR gym_id LIKE '%$search%')";
}
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <form method="GET" class="d-flex" style="max-width: 300px;">
                <input type="text" name="search" class="form-control me-2"
                    placeholder="Search by Trainer, User or Gym ID"
                    ...
                    if (!empty($bookings)):
                        foreach ($bookings as $b): ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="edit.php?id=<?= $b['id']; ?>" class="btn btn-sm btn-warning me-1">Edit</a>
