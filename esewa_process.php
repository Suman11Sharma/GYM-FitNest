...
// Redirect URLs
$success_url = "http://localhost/GYM-FitNest/success_esewa.php?transaction_id={$transaction_id}";
$failure_url = "http://localhost/GYM-FitNest/index.php?status=failed&msg=" . urlencode("❌ Payment Failed!");
