...
// Redirect URLs
$success_url = "http://localhost/GYM-FitNest/Admin/Paid-Ads/success_esewa.php?transaction_id={$transaction_id}";
$failure_url = "http://localhost/GYM-FitNest/Admin/Paid-Ads/fail_esewa.php";
